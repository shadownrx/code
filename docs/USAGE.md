...
> Atajo: `npx shadownrx-code`, parado en tu proyecto, te hace un par de
> preguntas y escribe este archivo por vos — ver
> [`cli/README.md`](../cli/README.md). Lo que sigue es el mismo resultado, a
> mano.
